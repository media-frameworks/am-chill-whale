...
import ObservatoryCapture from "./observatory/ObservatoryCapture";
import ObservatoryFiles from "./observatory/ObservatoryFiles";
import ObservatoryEdit from "./observatory/ObservatoryEdit";
...
export class FractoObservatory extends Component {
   ...
   load_field_studies = () => {
      ObservatoryFiles.load_registry(files => {
         console.log("ObservatoryFiles.load_registry returns", files)
   ...
   render() {
      ...
      const field_study_modal = !in_new_field_study ? '' : <ObservatoryCapture
...
export default FractoObservatory;